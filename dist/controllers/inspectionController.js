...
export class InspectionController {
    constructor() {
        this.createInspection = async (req, res) => {
            try {
        ...
        this.getAllInspections = async (req, res) => {
            try {
                ...
                const inspectionsWithUserData = inspections.map((inspection) => {
        ...
        this.deleteInspection = async (req, res) => {
            try {
                const { id } = req.params;

        ...
        <>
            ...
            >
                <Flex 
                    ...
                    w='100%' gap={{base:'40px', lg:'10px'}}
                    justifyContent={{base:'center', lg:'space-between'}}
                >   
                    <Box display={{base:'flex',lg:'none'}} flexDirection={'column'} alignItems={'center'} gap={'12'}
                        w={{base:'fit-content',lg:'20%'}}
                    >
                        <Image src={'/footer.png'} alt='logo' w={'175px'} h={'130px'}/>
                        <Flex 
                            w={'fit-content'} gap={'30px'}
                            alignItems={'center'}
                        >
                            {
                                socials.map((item)=>(
                                    <Link href={`${item.page}`} key={item?.id}>
                                        <Box 
                                            ...
                                            borderRadius={'999px'}
                                            fontSize={'16px'} textColor={'#827053'}
                                        >
                                            {item?.logo}
                                        </Box>
                                    </Link>
                    ...
                    <Box display={{base:'none',lg:'flex'}} flexDirection={'column'} alignItems={'center'} gap={'12'}
                        w={{base:'fit-content',lg:'20%'}}
                    >
                        <Image src={'/footer.png'} alt='logo' w={'175px'} h={'130px'}/>
                        <Flex 

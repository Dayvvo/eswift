        ...
        <>
            ...
            >
                <Flex
                    ...
                    gap={'60px'} mb={{base:20,lg:40}}
                >
                    <Flex w={{base:'100%',lg:'50%'}} flexDir={'column'} gap={{lg:'30px'}} py={'20px'}>
                        <TextHeader Header={"Our Journey"} 
                            sub={"Our story is one of continuous growth and evolution. We started as a small team with big dreams, determined to create a real estate platform that transcended the ordinary. Over the years, we've expanded our reach, forged valuable partnerships, and gained the trust of countless clients."}
                        />
                        <Stats/>
                    </Flex>
                    <Flex w={{base:'100%',lg:'100%'}} bgImage={"url('/journeybg.png')"} bgPos={'center'} bgSize="cover" borderRadius={'12px'} overflow={'hidden'}>
                        <Image src={'/journey.png'} alt="our journey" width={1000} height={1000} layout="responsive"/>
                    </Flex>
                </Flex>
                <Flex bg={"transparent"}
                    flexDir='column'
                    py={{base:'40px',lg:"60px"}} 
                    width={"100%"} gap={{base:'24px', md:'48px'}}
                    alignItems={'center'}
                ...
                <Flex
                    ...
                    gap={'60px'}
                >
                    <Flex w={{base:'100%',lg:'50%'}} flexDir={'column'} gap={'30px'} py={{lg:'20px'}}>

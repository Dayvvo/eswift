import { Box, Checkbox, Flex , FormControl, FormHelperText, FormLabel, HStack, Input, InputGroup, InputLeftElement, InputRightElement, PinInput, PinInputField, Stack, Text } from "@chakra-ui/react"
            ...
            >
                ...
                >
                    ...
                    <Btn 
                        ...
                        borderRadius={'10px'} textColor={'#FFFFFF'} my={'24px'}
                    >
                        Submit Code
                    </Btn>
                    <Flex 
                    ...
                    >
                        ...
                        <Text 
                            fontWeight={500} fontSize={'14px'}
                            textColor={'var(--strong950)'} textDecor={'underline'}
                        >
                            Resend code
                        </Text>                      
                    </Flex>

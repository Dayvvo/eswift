    ...
    const clientReview = [
        {
            ...
            review:'Our experience with Eswift was outstanding. Their team`s dedication and professionalism made finding our dream home a breeze. Higly recommended!', 
            user: 'Wade Warren',
        ...
        },
        {
            ...
            review:'The Eswift team guided us through the entire buying process. Their knowledge and commitment to our needs were impressive. Thank you for your support!', 
            user: 'John Mans',
            location: 'Lagos, Nigeria'
        },
    ]
        ...
        <>
            ...
            >
                <TextHeader
                    ...
                    sub={"Read the success stories and heartfelt testimonials from our valued clients. Discover why they chose Eswift for their real estate needs."}                
                />
                            ...
                            >
                                ...
                                <Flex mt={'30px'} gap={'10px'} alignItems={'center'}>
                                    <Box
                                        ...
                                        overflow={'hidden'}
                                    >
                                        <Image src={'/avatar1.png'} width={'100%'} height={'100%'} alt=""/>
                                    </Box>
                                    <Box className="urbanist">
                                        <Text fontSize={'18px'} fontWeight={500} textColor={'white'}>
                                            {item?.user}
                                        </Text>
                                        <Text fontSize={'16px'} fontWeight={400} textColor={'#E1E4EA'}>
                                            {item?.location}
                                        </Text>
                                    </Box>
                                </Flex>
...
const FAQ =()=> {
    const FAQ = [
        ...
        },
        {
            ...
            response:'Find out about the necessary documenttation for listing your property with us.'
        },{
            id:3,
            title:'How can I contact an Eswift agent?',
            response:'Discover the different ways you can get in touch with our experienced agents.'
        },
        {
            id:4,
            title:'',
            ...
            >
                {
                    FAQ.map((item)=>(
                        <Box key={item?.id}
                            border={'1px solid #262626'} borderRadius={'10px'}
                            p={{base:'24px',lg:'40px'}}
                            className="antic"
                        >
                            <Text
                                fontSize={{base:'18px',lg:'20px'}}
                                fontWeight={400} mb={{base:'18px',lg:'24px'}}
                            >
                                {item?.title}
                            </Text>
                            <Text

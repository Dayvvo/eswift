...
import { Box, Text,Textarea, Flex, Image, FormControl, FormLabel, Input, Select, Checkbox} from "@chakra-ui/react";
            ...
            <Box>
                ...
                >
                    ...
                    >
                        {
                            contact.map((item)=> (
                                <Flex key={item?.id}
                                    ...
                                    w={{base:'100%', md:'40%', lg:'20%'}} h={'160px'}
                                    p={'20px'}
                                    textColor={'white'}
                                    className="urbanist"
                                ...
                                >
                                    ...
                                    <Flex position={'relative'}
                                        ...
                                        fontSize={'24px'}
                                    >
                                        <Image src="/Icon-Container.png" alt="" w={'60px'} height={'60px'} position={'absolute'}/>
                                        {item?.icon}
                                    </Flex>
                                    <Text mt={'16px'} className="urbanist" fontSize={'16px'} fontWeight={600}>
                                        {item?.title}
                                    </Text>
                                </Flex>
                            ))
                   ...
                   <Text
                    ...
                    <TextHeader Header="Let's Connect"
                        ...
                        <Flex w={'100%'} flexWrap={'wrap'} gap={{base:'20px',lg:'30px'}}>
                            <Flex flexDir={'column'} w={{base:'100%',md:'48%',lg:'30%'}}>
                                ...
                                <Input 
                                    ...
                                    textColor={'#666'} fontWeight={500} fontSize={{base:'12px',lg:'14px'}}
                                    type='text' 
                            ...
                            <Flex flexDir={'column'} w={{base:'100%',md:'48%',lg:'30%'}}>
                                ...
                                <Input 
                                    w={'100%'} h={'52px'}
                                    borderRadius={'6px'} border={'1px solid #262626'}
                                    textColor={'#666'} fontWeight={500} fontSize={{base:'12px',lg:'14px'}}
                                    type='email' 
